-- Map import CSV quotation_cnt into consumer_data_daily.leads_cnt (dashboard column name).
-- Requires public.consumer_data_daily to have a leads_cnt column (rename from quotation_cnt if needed).
